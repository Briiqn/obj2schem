...
Loads your .obj and material files, then rasterizes the mesh into a voxel grid on the GPU. Each voxel samples the model's texture and gets matched to the closest Minecraft block by average color. The result gets written as a .schem file you can import into WorldEdit.
...
```bash
./obj2schem <input.obj> <output.schem> [scale] [textures_dir]
```
...
**Example:**
```bash
./obj2schem ../models/car.obj red_car.schem 250 ../textures
```
